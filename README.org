...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (26050 34302 931404 0) :init (26050 34302 931380 0) :init-secs (0 0 105 0) :use-package-secs (0 0 270 0)))
