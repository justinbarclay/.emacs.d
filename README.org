...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (26014 11403 453901 0) :init (26014 11403 412178 0) :init-secs (0 0 439 0) :use-package-secs (0 0 42303 0) :config (26014 11403 412144 0) :config-secs (0 0 263 0)))
