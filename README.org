...
;; so we can (require 'use-package) even in compiled emacs to e.g. read 
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package paredit
    :hook
      (emacs-lisp-mode . '(lambda () (enable-paredit)))
      (common-lisp-mode . '(lambda () (enable-paredit)))
      (scheme-mode . '(lambda () (enable-paredit)))
      (lisp-mode . '(lambda () (enable-paredit)))
    :config
;;    (smartparents-monde-offset
)
#+END_SRC
*** parinfer
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package slack
    ...
    (slack-register-team
     ...
     :token "xoxp-279636748417-281227765863-279548432240-775f405378057f8041af895c10b8f875"
