...
#+RESULTS:
: +marginalia-display-project-name
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25320 56067 879427 525000) :init (25320 56067 879345 436000) :config (25320 56067 879264 428000) :config-secs (0 0 42 656000) :init-secs (0 0 318 399000) :use-package-secs (0 0 553 191000)))
