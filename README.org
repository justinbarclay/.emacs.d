...
#+begin_src emacs-lisp :tangle no
  (defun my/vertico-truncate-candidates (args)
    (if-let ((arg (car args))
             ...
             (l (length arg))
             ((> l w)))
        (setcar args (ivy-rich-switch-buffer-shorten-path arg 30)))
    args)
#+end_src
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25320 27551 331817 339000) :init (25320 27551 331731 298000) :config (25320 27551 331681 875000) :config-secs (0 0 100 169000) :init-secs (0 0 312 728000) :use-package-secs (0 0 467 583000)))
