...
** Company-Emoji
:PROPERTIES:
:ID:       bf963728-dc93-448a-a52e-0cc91d962bcb
:END:
#+BEGIN_SRC emacs-lisp
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24638 40402 87239 700000) :use-package-secs (0 4 801544 400000) :init (24638 40402 87218 0) :init-secs (0 0 34 900000)))
