...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25314 21214 854218 31000) :init (25314 19099 679475 703000) :init-secs (0 0 6 868000) :use-package-secs (0 0 3 840000) :config (25314 19101 840224 417000) :config-secs (0 0 19076 476000)))
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25314 20743 556789 545000) :init (25314 20743 555749 349000) :config (25314 20743 555731 39000) :config-secs (0 0 120 90000) :init-secs (0 0 197 200000) :use-package-secs (0 0 1372 970000)))
...
*** CSharper
Transient mode to manage building and running operations in CSharp Projects
#+begin_src emacs-lisp
(use-package sharper
  :bind
